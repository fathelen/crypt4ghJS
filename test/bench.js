...
async function encryption (input) {
...
encryption('/home/fabienne/Programms/Crypt4ghPython/TestDateien/8gb')
    ...
    .on('data', async function (d) {
      ...
      readStream2
        .on('data', async function (d2) {
          ...
          fs.writeFile(output, plaintext, (err) => {
            if (err) {
              console.log(err)
            }
          })
...
decryption('/home/fabienne/Projects/Crypt4ghJSCode/crypt4ghJS/testData/64gb.crypt4gh', '/home/fabienne/Projects/Crypt4ghJSCode/crypt4ghJS/testData/64gb.txt') */